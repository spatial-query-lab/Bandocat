...
//            {
            ...
            /* This file is the fake catalog page for the pennyfenner collection
            No data will be sent to the server, the user will just be redirected
            to a fake statistics paged name iindex.php*/
            window.location.href= "../../Forms/Statistics/statistics.php";
